...
CREATE TABLE public.PAY_GRADE (
                PAY_GRADE_CODE BIGINT NOT NULL,
                PAY_GRADE_NAME VARCHAR NOT NULL,
                CONSTRAINT pay_grade_code PRIMARY KEY (PAY_GRADE_CODE)
);
...
CREATE TABLE public.EMPLOYEE (
                ...
                EMPLOYEE_PARTY_ROLE_ASSIGNMENT_ID BYTEA NOT NULL,
                EMPLOYEE_PAY_GRADE_CODE BIGINT NOT NULL,
...
CREATE TABLE public.EMPLOYEE_ORGANIZATION (
                WORKGROUP_EMPLOYEE_ID BYTEA NOT NULL,
                WORKGROUP_ID BYTEA NOT NULL,
                ASSIGNMENT_BEGIN_DATE DATE NOT NULL,
                ASSIGNMENT_END_DATE DATE NOT NULL,
                CONSTRAINT employee_workgroup PRIMARY KEY (WORKGROUP_EMPLOYEE_ID, WORKGROUP_ID)
);
...
ALTER TABLE public.EMPLOYEE ADD CONSTRAINT pay_grade_employee_fk
FOREIGN KEY (EMPLOYEE_PAY_GRADE_CODE)
REFERENCES public.PAY_GRADE (PAY_GRADE_CODE)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
ALTER TABLE public.EMPLOYEE ADD CONSTRAINT party_role_assignment_employee_fk
FOREIGN KEY (EMPLOYEE_PARTY_ROLE_ASSIGNMENT_ID)
REFERENCES public.PARTY_ROLE_ASSIGNMENT (PARTY_ROLE_ASSIGNMENT_ID)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE public.EMPLOYEE_ORGANIZATION ADD CONSTRAINT employee_employee_organization_fk
FOREIGN KEY (WORKGROUP_EMPLOYEE_ID)
REFERENCES public.EMPLOYEE (EMPLOYEE_ID)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE public.ORG ADD CONSTRAINT employee_org_fk
FOREIGN KEY (ORG_LEADER_ID)
REFERENCES public.EMPLOYEE (EMPLOYEE_ID)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
ALTER TABLE public.EMPLOYEE_ORGANIZATION ADD CONSTRAINT org_employee_organization_fk
